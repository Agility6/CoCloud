...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new CoCloudBusinessException("AES128Util.aesDecode fail");
        }
        throw new CoCloudBusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(CoCloudConstants.COMMON_SEPARATOR).splitToList(decryptIdStr);
