...
-- ----------------------------
-- Table structure for co_cloud_file
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_file`;

CREATE TABLE `co_cloud_file`
(
...
-- ----------------------------
-- Table structure for co_cloud_share
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_share`;
CREATE TABLE `co_cloud_share`
(
...
-- ----------------------------
-- Table structure for co_cloud_share_file
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_share_file`;
CREATE TABLE `co_cloud_share_file`
(
...
-- ----------------------------
-- Table structure for co_cloud_user
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_user`;
CREATE TABLE `co_cloud_user`
(
...
-- ----------------------------
-- Table structure for co_cloud_user_file
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_user_file`;
CREATE TABLE `co_cloud_user_file`
(
...
-- ----------------------------
-- Table structure for co_cloud_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `co_cloud_user_search_history`;
CREATE TABLE `co_cloud_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for co_cloud_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `co_cloud_file_chunk`;
CREATE TABLE `co_cloud_file_chunk`
(
...
-- ----------------------------
-- Table structure for co_cloud_error_log
-- ----------------------------

DROP TABLE IF EXISTS `co_cloud_error_log`;
CREATE TABLE `co_cloud_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
