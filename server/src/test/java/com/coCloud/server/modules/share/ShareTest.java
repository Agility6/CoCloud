package com.coCloud.server.modules.share;
...
import com.coCloud.server.modules.share.enums.ShareTypeEnum;
...
public class ShareTest {
    ...
    public void createShareUrlSuccess() {
        ...
        CoCloudShareUrlVO vo = iShareService.create(createShareUrlContext);
    ...
    public void queryShareUrlListSuccess() {
        ...
        List<CoCloudShareUrlListVO> result = iShareService.getShares(queryShareListContext);
    ...
    public void queryShareFileListSuccess() {
        ...
        List<CoCloudUserFileVO> fileVOList = iShareService.fileList(queryChildFileListContext);
    ...
    public void init() {
        ...
        context.setUserId(1817818544557907968L);
        context.setShareType(ShareTypeEnum.NEED_SHARE_CODE.getCode());
        context.setShareDayType(ShareDayTypeEnum.PERMANENT_VALIDITY.getDays());
        context.setShareFileIdList(Lists.newArrayList(1817818924754788352L));
