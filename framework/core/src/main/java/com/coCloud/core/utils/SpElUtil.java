...
public class SpElUtil {
     ...
     private static final CoCloudExpressionEvaluator expressionEvaluator = new CoCloudExpressionEvaluator();
     ...
     */
    @Data
    private static class CoCloudExpressionEvaluator extends CachedExpressionEvaluator {
